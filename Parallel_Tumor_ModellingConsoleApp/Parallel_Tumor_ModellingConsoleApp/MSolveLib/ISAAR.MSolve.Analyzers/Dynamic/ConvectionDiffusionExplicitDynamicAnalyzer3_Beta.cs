...
namespace ISAAR.MSolve.Analyzers.Dynamic
{
    ...
    /// </summary>
    public class ConvectionDiffusionExplicitDynamicAnalyzer3_Beta : INonLinearParentAnalyzer //TODO: why is this non linear
    {
        ...
        public ConvectionDiffusionExplicitDynamicAnalyzer3_Beta(IStructuralModel model, ISolver solver, IConvectionDiffusionIntegrationProvider provider,
