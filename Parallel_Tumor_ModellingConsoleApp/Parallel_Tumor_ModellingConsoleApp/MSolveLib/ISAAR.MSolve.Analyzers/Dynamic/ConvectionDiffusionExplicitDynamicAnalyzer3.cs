...
namespace ISAAR.MSolve.Analyzers.Dynamic
{
    ...
    /// </summary>
    public class ConvectionDiffusionExplicitDynamicAnalyzer3 : INonLinearParentAnalyzer //TODO: why is this non linear
    {
        ...
        public ConvectionDiffusionExplicitDynamicAnalyzer3(IStructuralModel model, ISolver solver, IConvectionDiffusionIntegrationProvider provider,
