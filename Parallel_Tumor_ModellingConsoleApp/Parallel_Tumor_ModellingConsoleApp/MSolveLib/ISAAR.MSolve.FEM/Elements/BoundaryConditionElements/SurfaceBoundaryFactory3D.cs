...
{
    public class SurfaceBoundaryFactory3D
    {
        ...
        static SurfaceBoundaryFactory3D()
        {
            ...
            SurfaceBoundaryFactory3D.interpolations = interpolations;
            SurfaceBoundaryFactory3D.integrationsForStiffness = integrationsForStiffness;
            SurfaceBoundaryFactory3D.integrationsForMass = integrationsForMass;
        ...
        public SurfaceBoundary3D CreateElement(CellType cellType, IReadOnlyList<Node> nodes)
        {
            //TODO: check if nodes - interpolation and Gauss points - materials match
#if DEBUG
            interpolations[cellType].CheckElementNodes(nodes);
#endif
            return new SurfaceBoundary3D(commonThickness, nodes, interpolations[cellType],
