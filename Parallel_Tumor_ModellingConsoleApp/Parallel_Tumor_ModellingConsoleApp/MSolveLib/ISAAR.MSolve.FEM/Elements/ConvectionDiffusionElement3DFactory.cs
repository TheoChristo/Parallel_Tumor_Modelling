...
namespace ISAAR.MSolve.FEM.Elements
{
    public class ConvectionDiffusionElement3DFactory
    {
        ...
        public ConvectionDiffusionElement3DFactory(ConvectionDiffusionMaterial commonMaterial)
        {
            this.commonMaterial = commonMaterial;
        }

        public ConvectionDiffusionElement3D CreateElement(CellType cellType, IReadOnlyList<Node> nodes)
        {
